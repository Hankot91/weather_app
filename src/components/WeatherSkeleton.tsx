...
/**
 * Refleja el layout real de 12 columnas (hero+horas 5/12, globo grande 7/12,
 * métricas 8/12 + sol-luna 4/12, días a ancho completo) para que no haya
 * salto de layout al pasar de "cargando" a los datos reales.
 */
	...
	return (
		...
		>
			<div className="lg:col-span-5 flex flex-col gap-5 min-w-0">
				<div className="glass-panel flex flex-col items-center justify-center gap-3 w-full p-6">
			...
			<div className="lg:col-span-7 h-95 md:h-115 lg:h-full min-w-0">
